...
<section class="back-G">
  ...
  <div class="apply-box">
    ...
    <form method="get" action="manage.php">
      <fieldset>
        <legend><strong>List All EOIs</strong></legend>
        <p>List all current Expressions of Interest.</p>
    ...
    <form method="get" action="manage.php">
      <fieldset>
        <legend><strong>List by Job Reference</strong></legend>
    ...
    <form method="get" action="manage.php">
      <fieldset>
        <legend><strong>List by Applicant Name</strong></legend>
    ...
    <form method="post" action="manage.php">
      <fieldset>
        <legend><strong>Delete by Job Reference</strong></legend>
        <label for="job_ref_delete">Job Reference Number:</label>
        <input type="text" name="job_ref_delete" id="job_ref_delete">
        <input type="submit" value="Delete All" style="background-color: red; color: white;">
      </fieldset>
    </form>
    <hr class="end-line-heading">
    ...
    <form method="post" action="manage.php">
      <fieldset>
        <legend><strong>Change EOI Status</strong></legend>
